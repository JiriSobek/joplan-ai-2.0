...
"- Tučný text formátuj pomocí dvou hvězdiček, například **text**";
  ...
  const improvePrompt = `
Jsi profesionální redaktor. Přeformuluj následující text tak, aby byl jasnější a srozumitelnější. Pokud je text v bodech nebo je jinak nesouvislý, udělej z něho souvislý text ve větách.
